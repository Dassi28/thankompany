  ...
  return (
    ...
    <section className="mission-vision-section">
      ...
      <section className="best-products-section">
        <h3 className="section-title">
          {t('home_best_products_title')}: <strong>{t('home_best_products_slogan')}</strong>
        </h3>
        <div className="products-container">
          <div className="product-card">
            ...
            <div className="product-info">
              <h4>{t('home_product_1_name')}</h4>
              <p>{t('home_product_1_role')}</p>
            </div>
          </div>
          <div className="product-card">
            <div className="product-image">
            ...
            <div className="product-info">
              <h4>{t('home_product_2_name')}</h4>
              <p>{t('home_product_2_role')}</p>
            </div>
          </div>
          <div className="product-card">
            <div className="product-image">
            ...
            <div className="product-info">
              <h4>{t('home_product_3_name')}</h4>
              <p>{t('home_product_3_role')}</p>
            </div>
          </div>
          <div className="product-card">
            <div className="product-image">
            ...
            <div className="product-info">
              <h4>{t('home_product_4_name')}</h4>
              <p>{t('home_product_4_role')}</p>
            </div>
          </div>
        </div>
