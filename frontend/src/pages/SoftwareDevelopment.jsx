              ...
              <div className="service-content reverse">
                  <div className="service-text">
                      ...
                      <ul>
                          ...
                          <li>{t('software_dev_expertise_service_7')}</li>
                          <li>{t('software_dev_expertise_service_8')}</li>
                          <li>{t('software_dev_expertise_service_9')}</li>
                          <li>{t('software_dev_expertise_service_10')}</li>
                      </ul>
                  </div>
                  <div className="service-image">
              ...
              <div className="service-content">
                  <div className="service-text">
                      ...
                      <ul>
                          ...
                          <li>{t('software_dev_guarantee_service_5')}</li>
                      </ul>
